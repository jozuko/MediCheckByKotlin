...
class TookDatetimeTypeTest : ATestParent() {
    ...
    fun constructor_Calendar() {
        ...
        val remindDatetimeType = TookDatetimeType(now)

        now.set(Calendar.SECOND, 0)
        now.set(Calendar.MILLISECOND, 0)
        Assert.assertEquals(now.timeInMillis, remindDatetimeType.dbValue)
    }
    ...
    fun constructor_Long() {
        val now = Calendar.getInstance()
        val remindDatetimeType = TookDatetimeType(now.timeInMillis)
    ...
    fun constructor_TookDatetimeType() {
        val now = Calendar.getInstance()
        val remindDatetimeType = TookDatetimeType(TookDatetimeType(now))
    ...
    fun constructor_DateModelTimeModel() {
        ...
        val remindDatetimeType = TookDatetimeType(dateModel, timeModel)
